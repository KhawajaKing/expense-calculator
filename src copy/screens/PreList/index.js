...
const PreList = ({onSelectback, onSelectCategroy}) => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={{}}>
        {filterObjectsByType('list').length >= 1 ? (
          <View
            style={{
                  ...
                  <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                      ...
                      <RobotoText
                        ...
                        Do you want to delete this category? This process cannot
                        be undone.
                      </RobotoText>
      ...
      <View
        ...
        {filterObjectsByType('group').length >= 1 ? (
          <View
            style={{
              paddingHorizontal: 30,
              paddingVertical: 10,
        ...
        <FlatList
          data={filterObjectsByType('group')}
          numColumns={2}
          renderItem={({item, index}) => {
            return (
              <>
                  ...
                  <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                      ...
                      <RobotoText
                        ...
                        letterSpacing={1}
                        style={{textAlign: 'center', marginTop: 15}}>
                        Do you want to delete this Group? This process cannot be
                        undone.
                      </RobotoText>
                      <Row style={{marginTop: 30}}>
                        <TouchableOpacity
                          ...
                          onPress={() => setModalVisibleGroup(false)}>
                          <RobotoText>Cancel</RobotoText>
                        </TouchableOpacity>
